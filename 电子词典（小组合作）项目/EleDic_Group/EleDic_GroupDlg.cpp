...
void CEleDicGroupDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Text(pDX, IDC_EDIT3, word1);
	DDX_Text(pDX, IDC_EDIT4, cn1);
	DDX_Text(pDX, IDC_EDIT7, output1);
	DDX_Text(pDX, IDC_EDIT8, word21);
	DDX_Text(pDX, IDC_EDIT9, word3);
	DDX_Text(pDX, IDC_EDIT10, output2);
...
BEGIN_MESSAGE_MAP(CEleDicGroupDlg, CDialogEx)
	...
	ON_BN_CLICKED(IDC_BUTTON1, &CEleDicGroupDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CEleDicGroupDlg::OnBnClickedButton2)
...
BOOL CEleDicGroupDlg::OnInitDialog()
{
	...
	GetDlgItem(IDC_STATIC_ADDWORD)->SetFont(&font3);
	GetDlgItem(IDC_STATIC_CNMA)->SetFont(&font3);
	GetDlgItem(IDC_STATIC_ERR1)->SetFont(&font3);
	GetDlgItem(IDC_STATIC_ERR2)->SetFont(&font3);
	GetDlgItem(IDC_STATIC_CHAN)->SetFont(&font3);
	GetDlgItem(IDC_STATIC_DELWORD)->SetFont(&font3);
	...
	GetDlgItem(deleteTips)->SetFont(&font3);
	GetDlgItem(IDC_BUTTON1)->SetFont(&font3);
	GetDlgItem(IDC_BUTTON2)->SetFont(&font3);
...
//樊阳添加单词按钮
void CEleDicGroupDlg::OnBnClickedButton1()
{
	
}
//修改单词按钮
void CEleDicGroupDlg::OnBnClickedButton2()
{
